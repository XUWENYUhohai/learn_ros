...
"""autogenerated by genpy from demo_action/addActionResult.msg. Do not edit."""
import codecs
import sys
...
class addActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "demo_action/addActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','demo_action/addResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(addActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = demo_action.msg.addResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = demo_action.msg.addResult()
