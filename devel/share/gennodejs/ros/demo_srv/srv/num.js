...
class numRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type numRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type numRequest
    let len;
    let data = new numRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new numRequest(null);
...
class numResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type numResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type numResponse
    let len;
    let data = new numResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new numResponse(null);
