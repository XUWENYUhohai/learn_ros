...
class addActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = addGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new addActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = addGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new addGoal()
    }
